<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobLogList" border="true" stripe="true" @selection-change="handleSelectionChange">
...
export default {
  ...
  data() {
    return {
      ...
      // 查询参数
      // 任务组名字典
      jobGroupOptions: [{"dictValue":"DEFAULT","dictLabel":"默认组"},{"dictValue":"SYSTEM","dictLabel":"系统组"}],
      // 查询参数
      queryParams: {
        pageNum: 1,
        pageSize: 10,
