    ...
    <el-dialog :title="title" :visible.sync="openDataScope" width="800px" append-to-body>
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="用户">
          ...
          @right-check-change="change"></el-transfer>
        </el-form-item>
...
<script>
import { listRole, getRole, delRole, addRole, updateRole, exportRole, dataScope, changeRoleStatus, roleUserselect } from "@/api/system/role";
