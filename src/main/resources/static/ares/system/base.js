    ...
    $.extend({
        table: {
            ...
            search: function (my) {//查询条件
                ...
                var params = $('#' + params.tableId + '').bootstrapTable("getOptions");
                ...
                $('#' + params.tableId + '').bootstrapTable("refresh", params)
            },
            selectColumns: function (column) {
                return $.map($('#' + params.tableId + '').bootstrapTable("getSelections"), function (row) {
                    return row[column]
                })
            },
            ...
            refresh: function () {
                $('#' + params.tableId + '').bootstrapTable("refresh", {
        ...
        operate: {
            submit: function (url, type, dataType, data) {
                ...
                var config = {
                    ...
                    success: function (result) {
                        if (result.code == "403") {
                            location.href = location.origin + result.msg;
                        } else {
            ...
            batRemove: function () {
                ...
                var rows = $.map($('#' + params.tableId + '').bootstrapTable("getSelections"), function (row) {
                    return row["id"];
                })
                if (rows.length == 0) {
            ...
            saveSuccess: function (result) {
                ...
                } else if (result.code == web_status.NOAUTH) {
                    location.href = location.origin + result.msg;
                } else {
                    $.modal.alertError(result.msg);
                }
